	...
	<form class="lrm-form js-lrm-form" action="#0" data-action="login">
        <div class="lrm-fieldset-wrap">
            ...
            <div class="fieldset">
                ...
                <div class="input-label"><?= $username_label; ?></div>
                <input name="username" class="full-width has-padding has-border" type="text" aria-label="<?= $username_label; ?>" <?= $fields_required; ?> value="" autocomplete="username" data-autofocus="1">
                <span class="lrm-error-message"></span>
            </div>

            <div class="fieldset">
                <?php $pass_label = esc_attr(lrm_setting('messages/login/password', true)); ?>
                <div class="input-label"><?= $pass_label; ?></div>
                <input name="password" class="full-width has-padding has-border" type="password" aria-label="<?= $pass_label; ?>" <?= $fields_required; ?> value="">
                <span class="lrm-error-message"></span>
            ...
            <div class="fieldset">
                <div class="flex-section">
                    ...
                    <?php endif; ?>
                    <div class="fieldset--submit submit-button-container <?= esc_attr($fieldset_submit_class); ?>">
