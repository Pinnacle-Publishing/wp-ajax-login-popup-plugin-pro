<div class="lrm-reset-password-section <?php echo $users_can_register && $default_tab == 'lost-password' ? 'is-selected' : ''; ?>">
    <!-- reset password form -->
    <form class="lrm-form js-lrm-form" action="#0" data-action="lost-password">
        ...
        <div class="lrm-fieldset-wrap">
            ...
            <div class="fieldset">
                ...
                <div class="input-label"><?= $email_label; ?></div>
                <label class="image-replace lrm-email lrm-ficon-mail" title="<?= $email_label; ?>"></label>
                <input class="full-width has-padding has-border" name="user_login" type="text" <?= $fields_required; ?> data-autofocus="1" aria-label="<?= $email_label; ?>">
